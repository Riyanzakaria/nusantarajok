...
>
    ...
    @if(Auth::user()->role === 'admin')
        {{-- E-Commerce Panel --}}
        <div class="mb-8">
            <h3 class="font-sans text-xs font-700 uppercase tracking-wider mb-3" style="color: oklch(0.68 0.022 65);">Panel E-Commerce</h3>
            <div class="flex flex-wrap items-center gap-0" style="border: 1px solid oklch(0.22 0.02 55);">
                <a href="{{ route('admin.orders.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.67 0.13 66); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.75 0.11 67)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.67 0.13 66)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg> Pesanan Online
                </a>
                <a href="{{ route('admin.products.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg> Master Produk
                </a>
                <a href="{{ route('admin.car-variants.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/></svg> Varian Mobil
                </a>
                <a href="{{ route('admin.shipping-rates.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg> Tarif Ongkir
                </a>
            </div>
        </div>

        {{-- Layanan Custom Panel --}}
        <div class="mb-10">
            <h3 class="font-sans text-xs font-700 uppercase tracking-wider mb-3" style="color: oklch(0.68 0.022 65);">Panel Layanan Custom & Bengkel</h3>
            <div class="flex flex-wrap items-center gap-0" style="border: 1px solid oklch(0.22 0.02 55);">
                <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg> Kategori
                </a>
                <a href="{{ route('admin.galleries.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                ...
                <a href="{{ route('admin.pricelist.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> Pricelist
                </a>
                <a href="{{ route('admin.vehicle-categories.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62); border-right: 1px solid oklch(0.22 0.02 55);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg> Kategori Kendaraan
                </a>
                <a href="{{ route('admin.schedule.index') }}" class="flex items-center gap-2.5 px-5 py-3.5 font-sans font-700 text-sm transition-all duration-200" style="color: oklch(0.50 0.020 62);" onmouseover="this.style.color='oklch(0.93 0.012 75)'; this.style.background='oklch(0.155 0.022 55)'" onmouseout="this.style.color='oklch(0.50 0.020 62)'; this.style.background='transparent'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg> Jadwal Slot
                </a>
            </div>
        </div>
    @endif
